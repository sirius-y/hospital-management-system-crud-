...
$sql = "INSERT INTO staff (fname,mname,lname,gender,cont_no,category,address,email)
VALUES (:fname,:mname,:lname,:gender,:cont_no,:category,:address,:email)";
...
<div class="main">
    ...
    <form action="add.php" method="POST">
      ...
      <b>Work Domain</b>
      <br>
      <input style="width: 400px; height: 30px;" type="text" name="category" placeholder="category" required>
      <br><br>
