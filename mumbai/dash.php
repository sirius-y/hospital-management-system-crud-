...
<br>
    <form action="/adbms project/mumbai/doctor/doctor_h.php" method="POST">
    ...
    <p>-------------------------------------------------------------------------------------</p>
      ...
      <form action="/adbms project/mumbai/staff/staff_h.php" method="POST">
      ...
      <p>-------------------------------------------------------------------------------------</p>
        ...
        <form action="/adbms project/mumbai/patient/patient_h.php" method="POST">
