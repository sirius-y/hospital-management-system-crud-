...
<br>
    <form action="/adbms project/kolkata/doctor/doctor_h.php" method="POST">
    ...
    <p>-------------------------------------------------------------------------------------</p>
      ...
      <form action="/adbms project/kolkata/staff/staff_h.php" method="POST">
      ...
      <p>-------------------------------------------------------------------------------------</p>
        ...
        <form action="/adbms project/kolkata/patient/patient_h.php" method="POST">
