...
<div class="header">
  <h1>Hospital management system | Staff Actions</h1>
</div>

<div class="navbar">
  <a href="about_us.html" class="right">ABOUT US</a>
  <a href="home.html" class="right">HOME</a>
  <a href="staff_login.html" class="right">LOGOUT</a>
...
<br>
    <form action="/adbms project/kolkata/staff master/staff_dash.php" method="POST">
        <b>Press button for Branch's Master Controls</b><br><br>
        <!-- <input style="width: 400px; height: 30px;" type = "text" name="id" placeholder="ID"> -->
        <br> <br>
        <input style="width: 100px" type="submit" class="button" value="View Details">
