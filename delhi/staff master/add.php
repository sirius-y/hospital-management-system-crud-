...
<div class="main">
    ...
    <form action="add.php" method="POST">
      ...
      <b>Progress</b>
      <br>
      <input style="width: 50px; height: 30px;" type="text" name="progress"  placeholder="ph.number" required>
      <br><br>
      <b>Comment</b>
      <br>
      <input style="width: 400px; height: 50px;" type="text" name="comment" placeholder="email id" required>
<br><br>
